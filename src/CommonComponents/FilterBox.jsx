    ...
    <div className="absolute top-8 right-0 bg-white z-50  border border-gray-300 shadow-lg rounded-md p-4 w-[full] max-w-[280px] ">
      ...
      <div className="flex items-center mb-3">
        <input
          ...
          className="h-4 w-4"
          onChange={(e) =>
            handleSelectAllcheckBox(e.target.checked, "DeSelect")
          }
          checked={isAllSelected}
        />
        <label
          htmlFor="selectAll"
          className="ml-2 text-sm text-gray-800 font-semibold"
        >
          Select All
        </label>
      </div>
        ...
        {(() => {
              ...
              return (
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      onCheckboxSelect(row["ID"], e.target.checked)
                    }
                    className="h-4 w-4"
                  />
                  <label
          ...
          return (
            <>
              {results}
              {!hasResults && (
                <span className="text-sm text-gray-900">No Results Found</span>
              )}
            </>
          );
        })()}
